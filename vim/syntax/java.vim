...
" Last Change:	2015 March 01 " Please check :help java.vim for comments on some of the options available.  " quit when a syntax file was already loaded
...
syn keyword javaType		      boolean char byte short int long float double String
...
" Custom Additions from me while Working in FXML
" vim: ts=8

syn keyword javaType		      SimpleStringProperty SimpleIntegerProperty
